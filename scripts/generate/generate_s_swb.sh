...
for MODEL_NAME in "/scratch-shared/mariog/surprise/models/gpt2/switchboard/" "/scratch-shared/mariog/surprise/models/microsoft/DialoGPT-small/switchboard/" "/scratch-shared/mariog/surprise/models/facebook/opt-125m/switchboard/";
do
